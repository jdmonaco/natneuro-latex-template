...
% Nature-specific formatting packages
...
% commands to render everything.) The available sections are any of the \include'd 
% files in the document: title, abstract, text, endnotes, legends, methods, references,
% figures, supp/legends, supp/guide, supp/figures, and supp/tables.
%
% Some precooked \includeonly statements:
% \includeonly{text,references}
% \includeonly{legends,figures}
% \includeonly{methods}
% \includeonly{supp/guide}
% \includeonly{supp/figures,supp/tables}
